...
<div class="container">
    ...
    <div class="nav-container">
        <div class="breadcrumb">
            <a href="admin_dashboard.php" style="color: var(--primary-color); text-decoration: none;">
                <i class="fas fa-home"></i> Dashboard
            </a> 
            / 
            <a href="inbox.php" style="color: var(--primary-color); text-decoration: none;">
        ...
        <div class="action-buttons">
            <button class="btn btn-success" onclick="location.href='inbox.php'">
                <i class="fas fa-inbox"></i> Inbox
            </button>
        ...
        <form method="post" action="compose.php" class="compose-form">
            ...
            <div class="form-actions">
                ...
                <div style="display: flex; gap: 10px;">
                    <button type="button" class="btn btn-danger" onclick="location.href='inbox.php'">
